...
ALLOWED_HOSTS = ['fotoblog-production.up.railway.app','127.0.0.1']
...
INSTALLED_APPS = [
    ...
    'cloudinary_storage', # Before contrib.staticfiles to serve static as well
...
CLOUDINARY_STORAGE = {
    ...
    'API_SECRET': os.environ.get('CLOUDINARY_API_SECRET'),
     'MEDIA_TAG': 'fotoblog_media',
     'STATIC_TAG': 'fotoblog_static',
}
